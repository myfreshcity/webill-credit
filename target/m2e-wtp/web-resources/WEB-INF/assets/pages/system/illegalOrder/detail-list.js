(function() {
    'use strict';
   $("input[name='penalizeId']").keyup(function(){
    	var penalizeId =$(this).val();
    	var tid =$(this).prev("input[name='tid']").val();
    	$(this).next("input[name='penalizeIds']").val(tid+"|"+penalizeId);
    });
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": BASE_PATH+'illegalOrder/detailList/'+data, // ajax source
                },
                "columns": [
                    { "data": "occurTime" },
                    { "data": "address" },
                ...
                "columnDefs": [
                    {
                        ...
                        "render": function ( data, type, row ) {
                            return '<a href=\"'+BASE_PATH+'illegal-order/edit/'+data+'\" class=\"btn btn-sm btn-outline grey-salsa\"> 编辑</a>';
                            //return data +' ('+ row[3]+')';
                        }
                    }
                ],
    ...
    function save() {
        $.ajax({
            type: 'POST',
            url: BASE_PATH+'illegalOrder/confirmPay',
