    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": { // language settings
                        // metronic spesific
                        "metronicGroupActions": "_TOTAL_ 记录已选中:  ",
                        "metronicAjaxRequestGeneralError": "操作失败。请检查网络环境或联系管理员",
            ...
            tableContainer.on('click', '.filter-cancel', function(e) {
                ...
                $('#receiverOrg').trigger('change.select2')
                $('#receiverId').trigger('change.select2');
            });
        },
