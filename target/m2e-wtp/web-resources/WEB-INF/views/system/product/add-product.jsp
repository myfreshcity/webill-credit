		...
		if(validateForm()){  
		    $.ajax({
		        ...
		        success: function (data) {
		        	if(data.status==200){
		        		alert(data.msg);
		        		window.location.href=BASE_PATH+"/product/thirdPartList";
		        	}
		        },
		        error: function () {
		            alert(data.msg);
				...
				<div class="portlet-body">
					<h4><span class="caption-subject font-dark sbold uppercase">基本信息</span></h4>
						<div class="form-body">
							...
							<textarea rows="5" cols="100" name="protectItems" class="col-xs-12" style="display:none">${prod.protectItems}</textarea>
							...
							<input type="text" value="${autoPay}" onkeyup="this.value=value.replace(/[^\u4E00-\u9FA5\w\\,\\，\\.\\。\\(\\)]/g,'')" style="display:none"/>
							...
							<div class="form-group">
								<label class="control-label col-md-3">支付方式<span
										class="required"> * </span>
								</label>
                                <div class="col-md-3">
                                    <div class="icheck-inline">
                                        <label><input type="radio" name="autoPay" checked class="icheck" value="0">手动支付</label>
                                        <label><input type="radio" name="autoPay" class="icheck" value="1">银行代扣</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
					...
					<div class="portlet-body">
						...
						<div class="table-container">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
                                    <div class="icheck-inline">
                                        <label><input type="radio" name="recommend" checked class="icheck" value="0">是</label>
                                        <label><input type="radio" name="recommend" class="icheck" value="1">否</label>
                                    </div>
                                </div>
                            </div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
						 		<button type="button" id="addProdBut" class="btn green-meadow" onclick="addProduct()">完成，添加商品</button>
							</div>
						</div>
					</div>
...
<!-- END PAGE LEVEL PLUGINS -->
<script src="${base}/assets/pages/system/product/add-product.js" type="text/javascript"></script>
</content>
</body>
</html>
