...
import com.webill.framework.annotations.FieldStrategy;
import com.webill.framework.service.mapper.DBType;
import com.webill.framework.service.mapper.IMetaObjectHandler;
import com.webill.framework.service.mapper.ISqlInjector;
...
public class MybatisSessionFactoryBuilder extends SqlSessionFactoryBuilder {
	...
	public SqlSessionFactory build(Reader reader, String environment, Properties properties) {
		try {
			com.baomidou.mybatisplus.MybatisXMLConfigBuilder parser = new com.baomidou.mybatisplus.MybatisXMLConfigBuilder(reader, environment, properties);
	...
	public SqlSessionFactory build(InputStream inputStream, String environment, Properties properties) {
		try {
			com.baomidou.mybatisplus.MybatisXMLConfigBuilder parser = new MybatisXMLConfigBuilder(inputStream, environment, properties);
			return build(parser.parse());
		} catch (Exception e) {
			throw ExceptionFactory.wrapException("Error building SqlSession.", e);
		} finally {
