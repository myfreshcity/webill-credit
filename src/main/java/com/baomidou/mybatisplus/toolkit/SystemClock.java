...
public class SystemClock {
    ...
    private static class InstanceHolder {
        public static final com.baomidou.mybatisplus.toolkit.SystemClock INSTANCE = new com.baomidou.mybatisplus.toolkit.SystemClock(1);
    }

    private static com.baomidou.mybatisplus.toolkit.SystemClock instance() {
