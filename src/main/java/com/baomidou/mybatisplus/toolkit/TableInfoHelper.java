...
public class TableInfoHelper {
	 ...
	 * 缓存反射类表信息
	 */
	private static Map<String, com.baomidou.mybatisplus.toolkit.TableInfo> tableInfoCache = new ConcurrentHashMap<String, com.baomidou.mybatisplus.toolkit.TableInfo>();
	 ...
	 * @return
	 */
	public static com.baomidou.mybatisplus.toolkit.TableInfo getTableInfo(Class<?> clazz) {
	 ...
	 * @return
	 */
	public synchronized static com.baomidou.mybatisplus.toolkit.TableInfo initTableInfo(Class<?> clazz) {
		com.baomidou.mybatisplus.toolkit.TableInfo ti = tableInfoCache.get(clazz.getName());
		if (ti != null) {
			return ti;
		}
		com.baomidou.mybatisplus.toolkit.TableInfo tableInfo = new TableInfo();
