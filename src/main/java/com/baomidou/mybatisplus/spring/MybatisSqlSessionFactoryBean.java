...
public class MybatisSqlSessionFactoryBean
	...
	private static final Log LOGGER = LogFactory.getLog(com.baomidou.mybatisplus.spring.MybatisSqlSessionFactoryBean.class);
	...
	private String environment = com.baomidou.mybatisplus.spring.MybatisSqlSessionFactoryBean.class.getSimpleName();
