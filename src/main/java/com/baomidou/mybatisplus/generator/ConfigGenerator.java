...
public class ConfigGenerator {
	...
	protected com.baomidou.mybatisplus.generator.ConfigBaseEntity configBaseEntity = null;
	...
	public String getSuperService() {
		if (StringUtils.isEmpty(superService)) {
			if (this.getConfigIdType() == ConfigIdType.STRING) {
				return "com.mmh.framework.service.ICommonService";
			} else {
				return "com.mmh.framework.service.ISuperService";
			}
		}
		return superService;
	}
	...
	public String getSuperServiceImpl() {
		if (StringUtils.isEmpty(superServiceImpl)) {
			if (this.getConfigIdType() == ConfigIdType.STRING) {
				return "com.mmh.framework.service.impl.CommonServiceImpl";
			} else {
				return "com.mmh.framework.service.impl.SuperServiceImpl";
			}
		}
		return superServiceImpl;
	}

	public com.baomidou.mybatisplus.generator.ConfigBaseEntity getConfigBaseEntity() {
