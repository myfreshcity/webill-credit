...
public class ExportExcel<T> {
    ...
    public void exportExcel(Collection<T> dataset, OutputStream out) {
        exportExcel("手机订单", null, dataset, out, "yyyy-MM-dd");
    }

    public void exportExcel(String[] headers, Collection<T> dataset,
            OutputStream out) {
        exportExcel("手机订单", headers, dataset, out, "yyyy-MM-dd");
    }
    public HSSFWorkbook exportExcel(String[] headers, Collection<T> dataset) {
      return exportExcel("手机订单", headers, dataset, "yyyy-MM-dd");
    }

    public void exportExcel(String[] headers, Collection<T> dataset,
            OutputStream out, String pattern) {
        exportExcel("手机订单", headers, dataset, out, pattern);
    }
