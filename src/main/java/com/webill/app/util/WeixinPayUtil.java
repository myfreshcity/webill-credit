...
import com.webill.app.WeixinInfoDTO;
...
public class WeixinPayUtil {
	...
	public static String getPayNo(String url, String xmlParam) {
		...
		try {
			...
			logger.error("****getPayNo for url:"+url+"，返回结果："+jsonStr);
			e.printStackTrace();
		}
		return prepay_id;
	}
	 ...
	 * @throws Exception 
	 */
	public static Map checkWxOrderPay(String tradeNo) throws Exception{
		String nonce_str = UUID.randomUUID().toString().replaceAll("-", "");
		Boolean payFlag = false;
		String sign = "";
		SortedMap<String, String> storeMap = new TreeMap<String, String>();
		storeMap.put("out_trade_no", tradeNo); // 商户 后台的贸易单号
